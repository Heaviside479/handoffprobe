...
The HandoffProbe v0.3.0 release-candidate safety boundary keeps active tests defaulted to local/loopback fixtures. Bundled tools must use harmless synthetic side effects wherever possible.
